...
description: "Use when answering questions about Pathfinder Second Edition (PF2e) rules, mechanics, character options, spells, feats, monsters, equipment, conditions, actions, or any other game-system detail. Triggers: mentions of PF2e, Pathfinder 2nd edition, Pathfinder 2e, skill checks, DCs, actions, reactions, free actions, conditions, ancestry, heritage, background, class feats, general feats, skill feats, spells, rituals, monsters, CR, equipment, items, traits, remastered rules, legacy rules, Archives of Nethys. Use this skill whenever the user asks for rules clarification, stat-block help, build advice, or mechanical rulings in Pathfinder 2e — even if they don't name the edition explicitly but the context is clearly PF2e."
---
